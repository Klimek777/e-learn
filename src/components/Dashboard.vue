    ...
    <div class="bg-white py-24 sm:py-32 flex justify-center items-center">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Your Courses</h2>
          <p class="mt-2 text-lg leading-8 text-gray-600">Develop your skills with courses on COURSEMATE</p>
        </div>
